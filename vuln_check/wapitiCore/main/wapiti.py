...
def wapiti_main():
    banners = [
                """
                     _               _               _    
        __   ___   _| |_ __      ___| |__   ___  ___| | __
        \ \ / / | | | | '_ \    / __| '_ \ / _ \/ __| |/ /
         \ V /| |_| | | | | |  | (__| | | |  __/ (__|   < 
          \_/  \__,_|_|_| |_|___\___|_| |_|\___|\___|_|\_|
                           |_____|                        """
    ]

    print(choice(banners))
    print("Vuln_check-1.0 ")
    moon_phase = phase()
    # if moon_phase == "full":
    ...
    parser = argparse.ArgumentParser(description="Vuln_check-1.0: Web application vulnerability scanner")
